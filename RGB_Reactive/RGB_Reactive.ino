...
void loop(){
  ...
  Serial.println(" hz");
  if(frequency<1000) analogWrite(BLUEPIN,255);
  else analogWrite(BLUEPIN,0);
  if(frequency<8000&&frequency>1000) analogWrite(REDPIN,255);
  else analogWrite(REDPIN,0);
  if(frequency<20000&&frequency>8000) analogWrite(GREENPIN,150);
